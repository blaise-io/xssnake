...
xss.extend(
    xss.room.ServerPlayer.prototype,
    /** @lends {xss.room.ServerPlayer.prototype} */ {
        destruct: function () {
            if (this.connected) {
                this.disconnect();
            }
        ...
        onmessage: function (jsonStr) {
            const message = new xss.netcode.Message(jsonStr);
        ...
        getMaxMismatchesAllowed: function () {
            const latency = Math.min(xss.NETCODE_SYNC_MS, this.heartbeat.latency);
