...
describe("Server", function () {
    describe("Room", function () {
        describe("Matcher", function () {
            ...
            let room, matcher, matchingOptions;
            const dummyEmitter = jasmine.createSpyObj("dummyEdmitter", ["on", "send"]);
            const dummyLevelset = jasmine.createSpyObj("dummyLevelset", ["getRandomLevelIndex"]);
            const dummyServer = { emitter: dummyEmitter };
            ...
            it("Matches an empty room", function () {
                expect(matcher.getRoomMatching(matchingOptions)).toEqual(
                    jasmine.any(xss.room.ServerRoom)
                );
            });
