    ...
    describe("Room", function () {
        describe("Options", function () {
            ...
            it("Matches when requester wants a quick game", function () {
                const requestOptions = new xss.room.ServerOptions();
            ...
            it("Does not apply for quick game when room is private", function () {
                ...
                expect(
                    existingOptions.matches(new xss.room.Options(new xss.room.ServerOptions()))
                ).toBeFalsy();
            });
            ...
            it("Serializes", function () {
                const s = existingOptions.serialize();
